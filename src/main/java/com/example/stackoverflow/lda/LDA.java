package com.example.stackoverflow.lda;

import com.example.stackoverflow.utilities.LDAUtilities;
...
public class LDA {
	...
	public LDA(int topicsNum, List<String> documents) throws IOException{
		...
		for(String doc : documents){
			...
			porterStemmer.setCurrent(docWoSW);
			porterStemmer.stem();
			docWoSW = porterStemmer.getCurrent();
			System.out.println(docWoSW);
